        ...
        <div className="flex h-screen bg-gray-50 font-sans text-gray-900 overflow-hidden flex-col md:flex-row">
            ...
            <aside className="hidden md:flex w-64 bg-white border-r border-gray-200 flex-col shadow-sm z-10">
                <div className="p-6 flex flex-col gap-1">
                    ...
                    <div className="pl-11 text-xs font-semibold text-gray-500 uppercase tracking-wider truncate max-w-[200px]" title={JSON.parse(localStorage.getItem('salao_user') || '{}')?.salon?.name}>
                        {JSON.parse(localStorage.getItem('salao_user') || '{}')?.salon?.name || 'Seu Salão'}
                    </div>
                    {/* License Badge */}
